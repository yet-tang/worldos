from worldos_core.behavioral_phenotype import build_behavioral_phenotype, phenotype_numeric_metrics
...
def test_scarcity_phenotype_summarizes_timing_participation_and_bursts():
    events = [
        ...
        _event(2, 5, "scarcity.perceived", "b"),
        _event(3, 7, "scarcity.purchase", "a", ("c",)),
        _event(4, 8, "rumor.generated", "b"),
    ]
...
def test_conflict_phenotype_accepts_existing_conflict_event_variants():
    events = [
        _event(1, 10, "resource_conflict_propensity", "a", ("b",)),
        _event(2, 11, "decision.resource_conflict", "a", ("b",)),
        _event(3, 12, "conflict.resolved", "a", ("b",)),
        _event(4, 13, "trade.completed", "a", ("b",)),
    ]
...
def test_phenotype_numeric_metrics_are_campaign_ready_and_deterministic():
    events = [
        _event(1, 2, "rumor.generated", "a"),
        _event(2, 3, "rumor.spread", "a", ("b",)),
        _event(3, 3, "rumor.rejected", "b", ("a",)),
    ]
...
def test_actor_filter_keeps_events_when_actor_is_subject():
    events = [
        _event(1, 1, "trade.completed", "seller", ("buyer",)),
        _event(2, 2, "trade.completed", "other", ("third",)),
    ]
